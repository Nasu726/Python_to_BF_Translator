...
def test_totalcandidate_partition_matches_reference_and_carries_state():
    cases = [
        [5, -2, 10, 1234, -77],
        [1, 2, 3, 4],
        [15, 16, 7, 8, 255, 256],
...
def test_totalcandidate_partition_handles_int64_edges():
    cases = [
        ([2**62, 2**62], (1 << 63) - 1),
        ([(1 << 63) - 1, 1], (1 << 63) - 1),
        ([-(1 << 63), 0], (1 << 63) - 1),
        ([0x7FFF_FFFF_FFFF_FFF0, 15, -31], (1 << 63) - 1),
        ([-0x7000_0000_0000_0000, 0x1000_0000_0000_0000, 7], (1 << 63) - 1),
    ]
