...
from bfhexpartition_absbranchfused import run_partition_min_pass
...
def test_branch_fused_partition_matches_reference_for_both_sign_branches():
    for values in (
        [1, 2, 3, 4],
        [5, -2, 10, 1234, -77],
        [15, 16, 7, 8, 255, 256],
...
def test_branch_fused_partition_handles_negation_carry_and_int64_edges():
    for values in (
...
def test_branch_fused_partition_rejects_non_nonnegative_initial_answer():
