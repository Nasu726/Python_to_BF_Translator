...
from bfhexpartition_movefused import run_partition_min_pass
...
def test_movefused_partition_matches_reference_and_carries_state():
    cases = [
        [5, -2, 10, 1234, -77],
        [1, 2, 3, 4],
        [15, 16, 7, 8, 255, 256],
...
def test_movefused_partition_handles_high_nibble_and_int64_edges():
    cases = [
        ([2**62, 2**62], (1 << 63) - 1),
        ([(1 << 63) - 1, 1], (1 << 63) - 1),
        ([-(1 << 63), 0], (1 << 63) - 1),
