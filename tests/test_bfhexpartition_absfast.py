...
from bfhexpartition_absfast import run_partition_min_pass
...
def test_absfast_partition_matches_reference():
    cases = [
        [1, 2, 3, 4],
        [5, -2, 10, 1234, -77],
        [15, 16, 7, 8, 255, 256],
        [-1, 0, 1, -16, 17],
        [0, 1, (1 << 63) - 1],
        # Long zero nibbles force the two's-complement carry to propagate.
        [0x10000, -0x20000, 0],
    ]
    for values in cases:
...
def test_absfast_partition_int64_edges():
    cases = [
        ([2**62, 2**62], (1 << 63) - 1),
        ([(1 << 63) - 1, 1], (1 << 63) - 1),
        ([-(1 << 63), 0], (1 << 63) - 1),
